...
class SumChatAuto(QMainWindow):
    def __init__(self, stats: list[int]):
        ...
        title = Title("Chat Box with Automation Task Complete")
        main_layout.addWidget(title)
        main_layout.addSpacing(10)

        participate = Subtitle("Congratulations! You have successfully completed the Chat Box with Automation task.")
...
def StartMulti(self):
    self.instrMulti = InstrMultiAuto1()
