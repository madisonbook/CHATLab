...
from SingleTaskSummaries.SumMtrAuto import SumMtrAuto
import random
import datetime
...
class PracMtrAuto(QMainWindow):
    def __init__(self):
        ...
        title = Title("Task: Multitasking with Automation 1")
        ...
        title = Title("Task: Practice Monitor Levels with Automation")
        main_layout.addWidget(title)
    ...
    def StartSummary(self):
        ...
        self.showSum = SumMtrAuto(summary)
